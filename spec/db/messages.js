...
const encoding52 = {
  preencode(state, m) {
    ...
    if (version >= 6 && m.clientId) c.string.preencode(state, m.clientId)
  },
  encode(state, m) {
    const flags = (version >= 6 && m.clientId) ? 1 : 0
    ...
    if (version >= 6 && m.clientId) c.string.encode(state, m.clientId)
  },
  decode(state) {
    const r0 = c.uint.decode(state)
    const r1 = c.uint.decode(state)
    ...
    return {
      ...
      timestamp: r1,
      data: r2,
      clientId: (version >= 6 && (flags & 1) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding54_4 = encoding1_4
...
const encoding54 = {
  preencode(state, m) {
    ...
    if (m.roles) encoding54_4.preencode(state, m.roles)
    if (m.createdBy) c.buffer.preencode(state, m.createdBy)
    if (m.createdAt) c.uint.preencode(state, m.createdAt)
    if (m.revokedAt) c.uint.preencode(state, m.revokedAt)
  },
  encode(state, m) {
    ...
    if (m.roles) encoding54_4.encode(state, m.roles)
    if (m.createdBy) c.buffer.encode(state, m.createdBy)
    if (m.createdAt) c.uint.encode(state, m.createdAt)
    if (m.revokedAt) c.uint.encode(state, m.revokedAt)
  },
  decode(state) {
    ...
    return {
      ...
      publicKey: r2,
      expires: r3,
      roles: (flags & 1) !== 0 ? encoding54_4.decode(state) : null,
      createdBy: (flags & 2) !== 0 ? c.buffer.decode(state) : null,
      createdAt: (flags & 4) !== 0 ? c.uint.decode(state) : 0,
      revokedAt: (flags & 8) !== 0 ? c.uint.decode(state) : 0
    }
...
const encoding57_1 = encoding1_4

// @autobonk/role-def/hyperdb#3
const encoding57 = {
  preencode(state, m) {
    encoding57_1.preencode(state, m.permissions)
    c.uint.preencode(state, m.rev)
    c.uint.preencode(state, m.index)
    c.uint.preencode(state, m.timestamp)
  },
  encode(state, m) {
    encoding57_1.encode(state, m.permissions)
    c.uint.encode(state, m.rev)
    c.uint.encode(state, m.index)
    c.uint.encode(state, m.timestamp)
  },
  decode(state) {
    const r1 = encoding57_1.decode(state)
    const r2 = c.uint.decode(state)
    const r3 = c.uint.decode(state)
    const r4 = c.uint.decode(state)
...
const encoding58_1 = encoding1_4

// @autobonk/acl-entry/hyperdb#4
const encoding58 = {
  preencode(state, m) {
    encoding58_1.preencode(state, m.roles)
    c.uint.preencode(state, m.rev)
    c.uint.preencode(state, m.index)
    c.uint.preencode(state, m.timestamp)
  },
  encode(state, m) {
    encoding58_1.encode(state, m.roles)
    c.uint.encode(state, m.rev)
    c.uint.encode(state, m.index)
    c.uint.encode(state, m.timestamp)
  },
  decode(state) {
    const r1 = encoding58_1.decode(state)
    const r2 = c.uint.decode(state)
    const r3 = c.uint.decode(state)
    const r4 = c.uint.decode(state)
...
// @bonk-docs/awareness/hyperdb#12
const encoding66 = {
  preencode(state, m) {
    c.uint.preencode(state, m.timestamp)
    c.buffer.preencode(state, m.data)
...
function getEncoding(name) {
  switch (name) {
    ...
    case '@bonk-docs/update/hyperdb#11':
      return encoding65
    case '@bonk-docs/awareness/hyperdb#12':
      return encoding66
    default:
