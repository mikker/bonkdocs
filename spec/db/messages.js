...
const encoding6 = {
  preencode(state, m) {
    ...
    c.uint.preencode(state, m.rev)
    if (version >= 3 && m.lockedAt) c.uint.preencode(state, m.lockedAt)
    if (version >= 3 && m.lockedBy) c.fixed32.preencode(state, m.lockedBy)
  },
  encode(state, m) {
    const flags =
      (m.title ? 1 : 0) |
      ...
      (m.updatedAt ? 4 : 0) |
      (m.creatorKey ? 8 : 0) |
      ((version >= 3 && m.lockedAt) ? 16 : 0) |
      ((version >= 3 && m.lockedBy) ? 32 : 0)
    ...
    c.uint.encode(state, m.rev)
    if (version >= 3 && m.lockedAt) c.uint.encode(state, m.lockedAt)
    if (version >= 3 && m.lockedBy) c.fixed32.encode(state, m.lockedBy)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      lockedAt: (version >= 3 && (flags & 16) !== 0) ? c.uint.decode(state) : 0,
      lockedBy: (version >= 3 && (flags & 32) !== 0) ? c.fixed32.decode(state) : null
    }
  }
}
...
const encoding11 = {
  preencode(state, m) {
    ...
    if (version >= 3 && m.lockedAt) c.uint.preencode(state, m.lockedAt)
    if (version >= 3 && m.lockedBy) c.string.preencode(state, m.lockedBy)
  },
  encode(state, m) {
    const flags =
      (m.joinedAt ? 1 : 0) |
      ...
      (m.lastRevision ? 8 : 0) |
      (m.lastOpenedAt ? 16 : 0) |
      ((version >= 3 && m.lockedAt) ? 32 : 0) |
      ((version >= 3 && m.lockedBy) ? 64 : 0)
    ...
    if (version >= 3 && m.lockedAt) c.uint.encode(state, m.lockedAt)
    if (version >= 3 && m.lockedBy) c.string.encode(state, m.lockedBy)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    ...
    return {
      ...
      lockedAt: (version >= 3 && (flags & 32) !== 0) ? c.uint.decode(state) : 0,
      lockedBy: (version >= 3 && (flags & 64) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding17 = {
  preencode(state, m) {
    const flags =
      ...
      ((version >= 3 && m.lockedAt) ? 256 : 0) |
      ((version >= 3 && m.lockedBy) ? 512 : 0)
  ...
  decode(state) {
    ...
    return {
      ...
      lockedAt: (version >= 3 && (flags & 256) !== 0) ? c.uint.decode(state) : 0,
      lockedBy: (version >= 3 && (flags & 512) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding45 = {
  ...
  decode(state) {
    ...
    return {
      ...
      rev: (version >= 2 && (flags & 2) !== 0) ? c.uint.decode(state) : 0
    }
  }
}

// @bonk-docs-rpc/lock-doc-request
const encoding46 = encoding27
...
const encoding47 = {
  ...
  encode(state, m) {
    const flags = (version >= 3 && m.rev) ? 1 : 0
...
const encoding48_4 = encoding1_4
...
const encoding48 = {
  preencode(state, m) {
    ...
    if (m.roles) encoding48_4.preencode(state, m.roles)
    if (m.createdBy) c.buffer.preencode(state, m.createdBy)
    if (m.createdAt) c.uint.preencode(state, m.createdAt)
    if (m.revokedAt) c.uint.preencode(state, m.revokedAt)
  },
  encode(state, m) {
    ...
    if (m.roles) encoding48_4.encode(state, m.roles)
    if (m.createdBy) c.buffer.encode(state, m.createdBy)
    if (m.createdAt) c.uint.encode(state, m.createdAt)
    if (m.revokedAt) c.uint.encode(state, m.revokedAt)
  },
  decode(state) {
    ...
    return {
      ...
      publicKey: r2,
      expires: r3,
      roles: (flags & 1) !== 0 ? encoding48_4.decode(state) : null,
      createdBy: (flags & 2) !== 0 ? c.buffer.decode(state) : null,
      createdAt: (flags & 4) !== 0 ? c.uint.decode(state) : 0,
      revokedAt: (flags & 8) !== 0 ? c.uint.decode(state) : 0
    }
...
const encoding51_1 = encoding1_4

// @autobonk/role-def/hyperdb#3
const encoding51 = {
  preencode(state, m) {
    encoding51_1.preencode(state, m.permissions)
    c.uint.preencode(state, m.rev)
    c.uint.preencode(state, m.index)
    c.uint.preencode(state, m.timestamp)
  },
  encode(state, m) {
    encoding51_1.encode(state, m.permissions)
    c.uint.encode(state, m.rev)
    c.uint.encode(state, m.index)
    c.uint.encode(state, m.timestamp)
  },
  decode(state) {
    const r1 = encoding51_1.decode(state)
    const r2 = c.uint.decode(state)
    const r3 = c.uint.decode(state)
    const r4 = c.uint.decode(state)
...
const encoding52_1 = encoding1_4

// @autobonk/acl-entry/hyperdb#4
const encoding52 = {
  preencode(state, m) {
    encoding52_1.preencode(state, m.roles)
    c.uint.preencode(state, m.rev)
    c.uint.preencode(state, m.index)
    c.uint.preencode(state, m.timestamp)
  },
  encode(state, m) {
    encoding52_1.encode(state, m.roles)
    c.uint.encode(state, m.rev)
    c.uint.encode(state, m.index)
    c.uint.encode(state, m.timestamp)
  },
  decode(state) {
    const r1 = encoding52_1.decode(state)
    const r2 = c.uint.decode(state)
    const r3 = c.uint.decode(state)
    const r4 = c.uint.decode(state)
...
function getEncoding(name) {
  switch (name) {
    ...
    case '@bonk-docs/snapshot/hyperdb#7':
      return encoding55
    case '@bonk-docs/presence/hyperdb#8':
      return encoding56
    case '@local/doc/hyperdb#9':
      return encoding57
    case '@local/state/hyperdb#10':
      return encoding58
    case '@local/profile/hyperdb#11':
      return encoding59
    default:
