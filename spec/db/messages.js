...
const encoding46 = {
  preencode(state, m) {
    ...
    if (version >= 4 && m.avatarMimeType) c.string.preencode(state, m.avatarMimeType)
  },
  encode(state, m) {
    const flags =
      ...
      ((version >= 4 && m.avatarMimeType) ? 8 : 0)
    ...
    if (version >= 4 && m.avatarMimeType) c.string.encode(state, m.avatarMimeType)
  },
  decode(state) {
    const flags = c.uint.decode(state)
    ...
    return {
      ...
      avatarMimeType: (version >= 4 && (flags & 8) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
// @bonk-docs-rpc/identity-avatar
const encoding52 = {
  preencode(state, m) {
    c.string.preencode(state, m.dataUrl)
    state.end++ // max flag is 2 so always one byte

    if (version >= 4 && m.mimeType) c.string.preencode(state, m.mimeType)
    if (version >= 4 && m.byteLength) c.uint.preencode(state, m.byteLength)
  },
  encode(state, m) {
    const flags =
      ((version >= 4 && m.mimeType) ? 1 : 0) |
      ((version >= 4 && m.byteLength) ? 2 : 0)

    c.string.encode(state, m.dataUrl)
    c.uint.encode(state, flags)

    if (version >= 4 && m.mimeType) c.string.encode(state, m.mimeType)
    if (version >= 4 && m.byteLength) c.uint.encode(state, m.byteLength)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      dataUrl: r0,
      mimeType: (version >= 4 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      byteLength: (version >= 4 && (flags & 2) !== 0) ? c.uint.decode(state) : 0
    }
  }
}

// @bonk-docs-rpc/get-identity-avatar-request
const encoding53 = encoding17

// @bonk-docs-rpc/get-identity-avatar-response.avatar
const encoding54_0 = c.frame(encoding52)

// @bonk-docs-rpc/get-identity-avatar-response
const encoding54 = {
  preencode(state, m) {
    state.end++ // max flag is 1 so always one byte

    if (version >= 4 && m.avatar) encoding54_0.preencode(state, m.avatar)
  },
  encode(state, m) {
    const flags = (version >= 4 && m.avatar) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 4 && m.avatar) encoding54_0.encode(state, m.avatar)
  },
  decode(state) {
    const flags = c.uint.decode(state)

    return {
      avatar: (version >= 4 && (flags & 1) !== 0) ? encoding54_0.decode(state) : null
    }
  }
}

// @bonk-docs-rpc/reset-identity-request
const encoding55 = encoding17

// @bonk-docs-rpc/reset-identity-response
const encoding56 = {
  preencode(state, m) {
    state.end++ // max flag is 1 so always one byte
  },
  encode(state, m) {
    const flags = (version >= 5 && m.reset) ? 1 : 0
  ...
  decode(state) {
    ...
    return {
      reset: (version >= 5 && (flags & 1) !== 0)
    }
  }
}

// @bonk-docs-rpc/apply-update-request
const encoding57 = encoding17

// @bonk-docs-rpc/apply-update-response
const encoding58 = encoding17

// @bonk-docs-rpc/updater-status-request
const encoding59 = encoding17
...
const encoding60 = {
  preencode(state, m) {
    ...
    if (version >= 6 && m.data) c.buffer.preencode(state, m.data)
  },
  encode(state, m) {
    const flags = (version >= 6 && m.data) ? 1 : 0

    c.string.encode(state, m.type)
    c.uint.encode(state, flags)

    if (version >= 6 && m.data) c.buffer.encode(state, m.data)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const flags = c.uint.decode(state)
    ...
    return {
      type: r0,
      data: (version >= 6 && (flags & 1) !== 0) ? c.buffer.decode(state) : null
    }
  }
}

// @autobonk/invite/hyperdb#0.roles
const encoding61_4 = encoding1_4
...
const encoding61 = {
  preencode(state, m) {
    ...
    if (m.roles) encoding61_4.preencode(state, m.roles)
    if (m.createdBy) c.buffer.preencode(state, m.createdBy)
    if (m.createdAt) c.uint.preencode(state, m.createdAt)
    if (m.revokedAt) c.uint.preencode(state, m.revokedAt)
  },
  encode(state, m) {
    ...
    if (m.roles) encoding61_4.encode(state, m.roles)
    if (m.createdBy) c.buffer.encode(state, m.createdBy)
    if (m.createdAt) c.uint.encode(state, m.createdAt)
    if (m.revokedAt) c.uint.encode(state, m.revokedAt)
  },
  decode(state) {
    ...
    return {
      ...
      publicKey: r2,
      expires: r3,
      roles: (flags & 1) !== 0 ? encoding61_4.decode(state) : null,
      createdBy: (flags & 2) !== 0 ? c.buffer.decode(state) : null,
      createdAt: (flags & 4) !== 0 ? c.uint.decode(state) : 0,
      revokedAt: (flags & 8) !== 0 ? c.uint.decode(state) : 0
    }
...
const encoding64_1 = encoding1_4

// @autobonk/role-def/hyperdb#3
const encoding64 = {
  preencode(state, m) {
    encoding64_1.preencode(state, m.permissions)
    c.uint.preencode(state, m.rev)
    c.uint.preencode(state, m.index)
    c.uint.preencode(state, m.timestamp)
  },
  encode(state, m) {
    encoding64_1.encode(state, m.permissions)
    c.uint.encode(state, m.rev)
    c.uint.encode(state, m.index)
    c.uint.encode(state, m.timestamp)
  },
  decode(state) {
    const r1 = encoding64_1.decode(state)
    const r2 = c.uint.decode(state)
    const r3 = c.uint.decode(state)
    const r4 = c.uint.decode(state)
...
const encoding65_1 = encoding1_4

// @autobonk/acl-entry/hyperdb#4
const encoding65 = {
  preencode(state, m) {
    encoding65_1.preencode(state, m.roles)
    c.uint.preencode(state, m.rev)
    c.uint.preencode(state, m.index)
    c.uint.preencode(state, m.timestamp)
  },
  encode(state, m) {
    encoding65_1.encode(state, m.roles)
    c.uint.encode(state, m.rev)
    c.uint.encode(state, m.index)
    c.uint.encode(state, m.timestamp)
  },
  decode(state) {
    const r1 = encoding65_1.decode(state)
    const r2 = c.uint.decode(state)
    const r3 = c.uint.decode(state)
    const r4 = c.uint.decode(state)
...
function getEncoding(name) {
  switch (name) {
    ...
    case '@bonk-docs-rpc/link-identity-response':
      return encoding51
    case '@bonk-docs-rpc/identity-avatar':
      return encoding52
    case '@bonk-docs-rpc/get-identity-avatar-request':
      return encoding53
    case '@bonk-docs-rpc/get-identity-avatar-response':
      return encoding54
    case '@bonk-docs-rpc/reset-identity-request':
      return encoding55
    case '@bonk-docs-rpc/reset-identity-response':
      return encoding56
